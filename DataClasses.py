...
# BEagleJack, 2021-Mar-11, added properties and setters to Track class
# BEagleJack, 2021-Mar-11, added methods to Track class
# BEagleJack, 2021-Mar-12, added functionality to append track to cd
# BEagleJack, 2021-Mar-12, added functionality to removetrack from cd
#------------------------------------------#
...
class CD:
    ...
    def cd_tracks(self, value):
        try:
            ...
            raise Exception('Tracks need to be a List!')
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        try:
            ...
            for track in self.__cd_tracks:
                if self.__cd_tracks[track_counter] == None:
                    track_counter += 1
                elif track.position == track_id:
                    del self.__cd_tracks[track_counter]
                    track_rmv = True
                    break 
                else:
                    track_counter += 1
